      ...
      <div className="">
        ...
        <div className='text-center'>
          ...
          <div className='flex flex-col justify-center items-center mb-[30px]'>
            <h2 className='text-[32px] font-bold pb-[10px] text-[#222] uppercase'>
              Special Products
            </h2>
            <hr className="w-[70px] border border-[#ff4c3b]"/>
        </div>
        </div>
        ...
        <div className="flex">
          {
            ...
            <div
              key={i}
              className="flex-none w-1/3 transition-transform duration-1000"
            >
              <div className="w-full bg-white px-3">
                <div className="relative overflow-hidden ">
                  ...
                  />
                  {/* Overlay */}
                  <div className="absolute inset-0 bg-[#ff4c3b] opacity-0 hover:opacity-50 transition-opacity duration-500 hover:rotate-[90] cursor-pointer"></div>
                </div>
                <div className="flex flex-col gap-[10px] justify-center items-center px-[15px]">
                  <h4 className="text-[18px] text-[#ff4c3b] mt-[20px] capitalize">{collection[index].title}</h4>
                 
                    <p className="text-[16px] text-[#222] text-center uppercase font-bold">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    </p>
                    <hr className="w-[70px] border border-[#ff4c3b]"/>
                  <h6 className="text-[14px] text-[#777] tracking-widest">By: John Dio, 2 Comments</h6>
                </div>
              </div>
            </div>
            ))
